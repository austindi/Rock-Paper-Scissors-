#############################################################################
# Makefile for building: simple_gui.app/Contents/MacOS/simple_gui
# Generated by qmake (3.1) (Qt 6.5.2)
# Project:  simple_gui.pro
# Template: app
# Command: /usr/local/bin/qmake -o Makefile simple_gui.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = simple_gui1.0.0
DISTDIR = /Users/dave/Desktop/Learn_C++/rock_paper_scissors/.tmp/simple_gui1.0.0
...
DIST          = /usr/local/share/qt/mkspecs/features/spec_pre.prf \
		...
		/usr/local/Cellar/qt/6.5.2/share/qt/mkspecs/common/unix.conf \
		/usr/local/Cellar/qt/6.5.2/share/qt/mkspecs/common/mac.conf \
		/usr/local/Cellar/qt/6.5.2/share/qt/mkspecs/common/macx.conf \
		/usr/local/Cellar/qt/6.5.2/share/qt/mkspecs/common/sanitize.conf \
		/usr/local/Cellar/qt/6.5.2/share/qt/mkspecs/common/gcc-base.conf \
		/usr/local/Cellar/qt/6.5.2/share/qt/mkspecs/common/gcc-base-mac.conf \
		/usr/local/Cellar/qt/6.5.2/share/qt/mkspecs/common/clang.conf \
		/usr/local/Cellar/qt/6.5.2/share/qt/mkspecs/common/clang-mac.conf \
		...
		simple_gui.pro  main.cpp
QMAKE_TARGET  = simple_gui
DESTDIR       = 
TARGET        = simple_gui.app/Contents/MacOS/simple_gui

####### Custom Variables
EXPORT_QMAKE_MAC_SDK = macosx
EXPORT_QMAKE_MAC_SDK_VERSION = 14.0
EXPORT_QMAKE_XCODE_DEVELOPER_PATH = /Library/Developer/CommandLineTools
EXPORT__QMAKE_STASH_ = /Users/dave/Desktop/Learn_C++/rock_paper_scissors/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/dave/Desktop/Learn_C++/rock_paper_scissors/simple_gui.pro


include /usr/local/Cellar/qt/6.5.2/share/qt/mkspecs/features/mac/sdk.mk
first: all
####### Build rules

simple_gui.app/Contents/MacOS/simple_gui:  $(OBJECTS)  
	@test -d simple_gui.app/Contents/MacOS/ || mkdir -p simple_gui.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: simple_gui.pro /usr/local/share/qt/mkspecs/macx-clang/qmake.conf /usr/local/share/qt/mkspecs/features/spec_pre.prf \
		/usr/local/share/qt/mkspecs/features/device_config.prf \
		/usr/local/Cellar/qt/6.5.2/share/qt/mkspecs/common/unix.conf \
		/usr/local/Cellar/qt/6.5.2/share/qt/mkspecs/common/mac.conf \
		/usr/local/Cellar/qt/6.5.2/share/qt/mkspecs/common/macx.conf \
	...
	$(QMAKE) -o Makefile simple_gui.pro
...
simple_gui.app/Contents/PkgInfo: 
	@test -d simple_gui.app/Contents || mkdir -p simple_gui.app/Contents
	@$(DEL_FILE) simple_gui.app/Contents/PkgInfo
	@echo "APPL????" > simple_gui.app/Contents/PkgInfo
simple_gui.app/Contents/Info.plist: 
	@test -d simple_gui.app/Contents || mkdir -p simple_gui.app/Contents
	@$(DEL_FILE) simple_gui.app/Contents/Info.plist
	@plutil -convert xml1 -o - /usr/local/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.simple-gui,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.simple-gui,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},13.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,simple_gui,g" -e "s,@LIBRARY@,simple_gui,g" -e "s,\$${EXECUTABLE_NAME},simple_gui,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >simple_gui.app/Contents/Info.plist

all: Makefile \
		simple_gui.app/Contents/PkgInfo \
		simple_gui.app/Contents/Info.plist simple_gui.app/Contents/MacOS/simple_gui
...
main.o: main.cpp /usr/local/lib/QtCore.framework/Headers/QString \
